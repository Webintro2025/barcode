        ...
        <div className="flex flex-col space-y-6 lg:grid lg:grid-cols-4 lg:gap-8 lg:space-y-0">
          ...
          <div className="lg:col-span-1">
            <div className="mb-4">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                Leading provider of comprehensive barcode solutions since 2003. We specialize in labeling, identification systems, and complete barcode infrastructure for businesses of all sizes.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 lg:contents">
            ...
            <div>
              ...
              <ul className="text-gray-300 text-xs lg:text-sm space-y-1 lg:space-y-1.5">
                <li>
                  <Link href="/about" className="hover:text-blue-400 cursor-pointer transition-colors">About Us</Link>
                </li>
                <li>
                  <Link href="#services" className="hover:text-blue-400 cursor-pointer transition-colors">Our Services</Link>
                </li>
                <li>
                  <Link href="/contact" className="hover:text-blue-400 cursor-pointer transition-colors">Contact Us</Link>
                </li>
          ...
          <div className="grid grid-cols-2 gap-4 lg:block">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-white font-semibold">info@srsb.com</p>
                  </div>
                </div>
              </div>
              ...
              <div className="hidden lg:block mt-6 lg:mt-8">
                ...
                <div className="flex flex-wrap gap-2">
                  <a href="#" className="w-6 h-6 lg:w-8 lg:h-8 bg-blue-600 rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors">
            ...
            <div className="lg:hidden">
              ...
              <div className=' w-16 h-0.5 bg-blue-600 mb-3.5'></div>
              <div className="flex flex-wrap gap-2">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center text-xs md:text-sm">
            <div className="text-gray-400 mb-2 md:mb-0 text-center md:text-left">
              © 2025 S.R.S.B. Barcode Solutions. All rights reserved. | Established 2003
            </div>
            <div className="flex flex-wrap items-center justify-center md:justify-end text-gray-400 text-xs md:text-sm">
              ...
              <span>by</span>
              <a href="https://webintro.in/" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition-colors font-medium mx-1">
                Webintro.in
              </a>
              <span>and</span>
              <a href="https://webintro.in/delhi/" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition-colors font-medium mx-1">
