...
const Contact = () => {
  return (
    ...
    <div id="contact" className="pt-32 "> {/* Added more padding-top and margin-top for better spacing */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl sm:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed transform transition-all duration-700 delay-200 group-hover:scale-102 group-hover:text-white animate-fadeInUp">
              Get in touch with S.R.S.B. Barcode Solutions for all your labeling and identification needs
            </p>
